...
$MerchantTradeNo = $_REQUEST["e_orderno"];
$RtnCode = $_REQUEST["result"];
$RtnMsg = $_REQUEST["ret_msg"];
$rCheckMacValue = $_REQUEST["str_check"];
$TradeAmt = $_REQUEST["e_money"];
$PaymentDate = $_REQUEST["e_date"];
$PaymentDate = date("Y-m-d", strtotime($PaymentDate))." "._r("e_time");
