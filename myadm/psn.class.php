...
private $img; //?像?源句柄
private $width=100; //?像?度
private $height=40; //?像高度
private $code;  //???
private $codeLength=4; //???的?度,4位
private $font; //字体 字体文件放在?前?本文件的font目?下
private $fontSize=20; //字体大小
private $fontColor;  //字体?色
private $randChar='abcdefghkmnpqrstuvwxyzABCDEFGHKLMNOPRSTUVWXYZ23456789'; //?机因子,去掉了一些相似的字符例如o0
...
$this->font=dirname(__FILE__).'/font/verdana.TTF';
}
