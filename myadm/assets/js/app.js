...
*************************************************** **/
   ...
   if($pathname.indexOf("/") >= 0) $pathname = $pathname.split("/")[2];
   if($pathname.indexOf(".") >= 0) $pathname = $pathname.split(".")[0];
   if($pathname.indexOf("_") >= 0) $pathname = $pathname.split("_")[0];

   $("#sideNav .nav li a").each(function() {
     var $collapse_a = $(this).attr("href");
     
     if($collapse_a.indexOf($pathname) >= 0) {     	     
     	 if($(this).parents("ul").length) $(this).parents("ul").show();    	 
