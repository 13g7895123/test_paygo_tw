...
<body>
    <form id='szfu_to_payok' method="post" action="https://gohost.tw/payment_background_szfu.php">
        ...
        <input type="hidden" name="domain" value="paygo">
    </form>
    <script type="text/javascript">
        document.getElementById('szfu_to_payok').submit();
    </script>
</body>